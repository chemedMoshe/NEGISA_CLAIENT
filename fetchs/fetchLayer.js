...
export const getAllUsersFetch = async () => {
    try {
        const response = await fetch("https://negisaserver-1.onrender.com/user/");
        const data = await response.json();
        return data;
    } catch (error) {
        return error
...
export const updateUserFetch = async (id, userUpdated) => {
    try {
        const response = await fetch(`https://negisaserver-1.onrender.com/user/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
...
export const searchUserFetch = async (username) => {
    try {
        const response = await fetch(`https://negisaserver-1.onrender.com/user/search`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
