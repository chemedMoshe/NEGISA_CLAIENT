...
import { createNewUserFetch } from "../fetchs/fetchLayer.js";
...
const createStatus = createElements("div")
...
async function showNewUser() {
    ...
    createStatus.classList.add("createStatus") 
    const createMessage = createElements("h2","טוען...")   
    createStatus.appendChild(createMessage);    
    contentByJs.appendChild(createStatus);
   
        const data = await createNewUserFetch(newUserObj())
